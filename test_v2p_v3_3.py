...
def main():
    ...
    save_path_m = './snapshots_p2v_v3_3_ca_0.3/p2v_0.45351781370187055_m.pth'
    ...
    save_path = './snapshots_p2v_v3_3_ca_0.3/p2v_0.45351781370187055.pth'
    ...
    web_dir = os.path.join('results/results_p2v_3_ca_0.3')
