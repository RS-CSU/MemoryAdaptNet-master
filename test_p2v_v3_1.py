...
def main():
    ...
    save_path_m = './snapshots_p2v_v3_1_ca_5.0/p2v_0.5200549985713411_m.pth'
    ...
    save_path = './snapshots_p2v_v3_1_ca_5.0/p2v_0.5200549985713411.pth'
    ...
    web_dir = os.path.join('results/results_p2v_1_ca_0.01')
